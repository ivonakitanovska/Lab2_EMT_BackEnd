...
public class DataInitializer {
    ...
    public void init(){
        ...
        Country country2 = new Country("United States", "Europe");
        ...
        Author author3 = new Author("Jen", "Sincero", country2);
        ...
        Book book1 = new Book("You Are a Badass at Making Money", Category.NOVEL, author3, 250);
        Book book2 = new Book("Anna Karenina", Category.NOVEL, author4, 120);
        Book book3 = new Book("Selo zad sedumte jaseni", Category.NOVEL, author1, 50);
        Book book4 = new Book("Milioni Machenici", Category.DRAMA, author2, 108);
        Book book5 = new Book("You Are a Badass", Category.NOVEL, author3, 190);
        Book book6 = new Book("Hamlet", Category.DRAMA, author5, 90);
